...
const AuthOutputValidationConfig = _.merge(
  {},
  ErrorsOutputValidations,
  NotFoundStatus,
  UnauthorizedStatus,
...
const AuthOnPutOutputValidationConfig = _.merge(
  {},
  ErrorsOnPutOutputValidations,
  {
    status: {
...
const AuthOnLoginOutputValidationConfig = _.merge(
  {},
  ErrorsOutputValidations,
  NotFoundStatus,
  {
...
const AuthOnRegisterOutputValidationConfig = _.merge(
  {},
  ErrorsOnPostOutputValidations,
  {
    status: {
...
const AuthOnGetOutputValidationConfig = _.merge(
  {},
  ErrorsWithAuthOutputValidations,
  ErrorsOnGetOutputValidations,
  {
